...
const InfosPratiques = ({data}) => (
 ...
 <Container text first>
    ...
    <h2>Billetterie</h2>
     <p>Nous vous recommandons de réserver votre place via notre <Link to="../billetterie">billetterie en ligne</Link>.</p><p> <b>Attention jauge limitée à 300 places</b>. <br/> Une billetterie physique sera également disponible le soir même sur place.
     </p>
     <p>Tarifs : 5€ (enfants de moins de 12ans), 10€ prix mini, 15€ prix conscient</p>
    <h2>Se loger</h2>
    <p>Un espace bivouac sera disponible le soir du concert. Vous trouverez la liste complète des hébergements (campings, chambres d'hôtes, hôtels, hébergements insolites..) sur le site de <a href="https://lamottechalancon.com/tourisme/hebergements/" target="_blank" rel="noreferrer noopener">la Motte Chalancon</a>.</p>
...
rel="noreferrer noopener" target="blank">benevolesrockontheloule@gmail.com</a>
  ...
  <h2>Comment venir ?</h2>
   ...
   <h2>A savoir</h2>    
    <p>Les chiens ne sont pas autorisés.</p>{/* 
