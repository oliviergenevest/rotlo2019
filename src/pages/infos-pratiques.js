...
const InfosPratiques = ({data}) => (
 ...
 <Container text first>
    ...
    <h2>Billetterie</h2>
     <p>Nous vous recommandons de réserver votre place via notre billetterie en ligne. <br/> Une billetterie physique sera également disponible le soir même sur place.
     </p>
